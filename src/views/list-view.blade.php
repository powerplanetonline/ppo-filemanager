...
<table class="table table-condensed table-striped">
  <thead>
    <th style='width:50%;'>{{ Lang::get('ppo-filemanager::lfm.title-item') }}</th>
    <th>{{ Lang::get('ppo-filemanager::lfm.title-size') }}</th>
    <th>{{ Lang::get('ppo-filemanager::lfm.title-type') }}</th>
    <th>{{ Lang::get('ppo-filemanager::lfm.title-modified') }}</th>
    <th>{{ Lang::get('ppo-filemanager::lfm.title-action') }}</th>
  </thead>
  <tbody>
    ...
    <tr>
      ...
      <td></td>
      <td>{{ Lang::get('ppo-filemanager::lfm.type-folder') }}</td>
      <td></td>
      <td></td>
    </tr>
    @endforeach
